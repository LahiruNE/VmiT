...
<script>
    $(document).ready(function(){     
        jque();
        $(".wrapper").append("<div class='counter col_fourth'><i class='fa fa-lightbulb-o fa-2x'></i><h2 class='timer count-title count-number' data-to='<?php echo $model->search()->getTotalItemCount();?>' data-speed='500'></h2><p class='count-text'>reservations have been submitted today.</p></div>");
    });
    ...
    {       
        ...
        jque();
        $(".wrapper").html("<div class='counter col_fourth'><i class='fa fa-lightbulb-o fa-2x'></i><h2>"+count+"</h2><p class='count-text'>reservations have been submitted today<br>(According to the searching criteria).</p></div>");
...
$this->menu=array(
	array('label'=>'Reservation History', 'url'=>array('history')),
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
            ...
            array('name'=>'Reason_ID', 'value'=>'!empty($data->reason->Reason_Description)?$data->reason->Reason_Description: "Not Submitted"'),
            'Nearest_City',
            //'Added_Date',
            array(
                'class' => 'CButtonColumn',
...
//                                                          )}}',
                ...
                'buttons' => array(
                    ...
                    (
                        ...
                        'url'=>'Yii::app()->createUrl("reservation/viewAdmin", array("id"=>$data->Reservation_ID))',
                    ),
                    'del' => array
                    (
                        'label'=>'Delete',
