...
<script>
    $(document).ready(function(){     
        jque();
        $(".wrapper").append("<div class='counter col_fourth'><i class='fa fa-lightbulb-o fa-2x'></i><h2 class='timer count-title count-number' data-to='<?php echo $model->search_history()->getTotalItemCount();?>' data-speed='500'></h2><p class='count-text'>total reservations have been submitted.</p></div>");
    });
    ...
    {       
        ...
        jque();
        $(".wrapper").html("<div class='counter col_fourth'><i class='fa fa-lightbulb-o fa-2x'></i><h2>"+count+"</h2><p class='count-text'>total reservations have been submitted<br>(According to the searching criteria).</p></div>");
...
$this->menu=array(
	array('label'=>'Current Reservations', 'url'=>array('admin')),
...
<?php $this->renderPartial('_search_history',array(
	'model'=>$model,
)); ?>
</div><!-- search-form -->
