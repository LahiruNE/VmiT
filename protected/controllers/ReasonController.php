...
class ReasonController extends Controller
{
			...
			if($model->save())
                        {
                            ...
                            $this->redirect(array('view','id'=>$model->Reason));
                        }
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Reason');
	...
	{
		$model=Reason::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Reason $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='reason-form')
		{
